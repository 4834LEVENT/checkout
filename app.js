...
let calTotal = () => {
 ...
 document.getElementById("subtotal").nextElementSibling.innerText = "$" + sumSubtotal.toFixed(2);

 document.getElementById("total").nextElementSibling.innerText = "$"+
    (taxPrice + shippingPrice + sumSubtotal).toFixed(2);
  
 document.getElementById("tax").nextElementSibling.innerText = "$" +  taxPrice.toFixed(2);
  
  document.getElementById("shipping").nextElementSibling.innerText= "$" +shippingPrice; 
};
